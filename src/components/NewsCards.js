...
rendrList() {
  ...
  const filteredData = this.props.news && this.props.news.filter((item) => {
  ...
  render() {
    return !this.state.isLoading ? (
      ...
      <div className="container">
                <input  className ="search-item" value={this.props.text}  onChange={this.handleChange} placeholder="Search..."/>
